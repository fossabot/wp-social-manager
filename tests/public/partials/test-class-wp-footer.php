...
class TestWPFooter extends WP_UnitTestCase {
	...
	public function test_icon_reference_svg() {
		...
		$this->assertEquals( 13, $symbols->length );
		...
		$this->assertEquals( $prefix . '-icon-dribbble', $symbols->item( 8 )->getAttribute( 'id' ) );
		$this->assertEquals( 'M12 22C6.487 22 2 17.512 2 12 2 6.487 6.487 2 12 2c5.512 0 10 4.487 10 10 0 5.512-4.488 10-10 10zm8.434-8.631c-.293-.093-2.644-.794-5.322-.365 1.118 3.07 1.573 5.57 1.66 6.09a8.57 8.57 0 0 0 3.663-5.725h-.001zm-5.097 6.506c-.127-.75-.624-3.36-1.825-6.475l-.055.018c-4.817 1.678-6.545 5.02-6.7 5.332A8.485 8.485 0 0 0 12 20.555a8.506 8.506 0 0 0 3.338-.679v-.001zm-9.683-2.15c.194-.333 2.537-4.213 6.944-5.638.112-.037.224-.07.337-.1-.216-.487-.45-.972-.694-1.45-4.266 1.275-8.403 1.222-8.778 1.213l-.004.26c0 2.194.831 4.197 2.195 5.713v.002zm-2.016-7.463c.383.007 3.902.022 7.897-1.04a54.666 54.666 0 0 0-3.166-4.94 8.576 8.576 0 0 0-4.73 5.982l-.001-.002zM10 3.71a45.577 45.577 0 0 1 3.185 5c3.037-1.138 4.325-2.866 4.478-3.085A8.496 8.496 0 0 0 12 3.47c-.688 0-1.359.083-2 .237v.003zm8.613 2.902C18.43 6.856 17 8.69 13.843 9.98a25.723 25.723 0 0 1 .75 1.678c2.842-.358 5.666.215 5.947.274a8.493 8.493 0 0 0-1.929-5.32h.002z', $paths->item( 8 )->getAttribute( 'd' ) );

		$this->assertEquals( $prefix . '-icon-behance', $symbols->item( 9 )->getAttribute( 'id' ) );
		$this->assertEquals( 'M20.038 7.552H15.04v-1.24h4.998v1.24zm-8.323 5.09c.322.498.484 1.105.484 1.817 0 .735-.183 1.396-.552 1.98-.235.385-.527.71-.878.974-.395.304-.863.512-1.4.623-.54.11-1.123.168-1.752.168h-5.59V5.795h5.993c1.51.026 2.582.463 3.215 1.323.38.527.567 1.16.567 1.895 0 .76-.19 1.366-.573 1.827-.214.26-.53.494-.946.706.632.23 1.11.594 1.43 1.095zM4.89 10.687h2.627c.54 0 .976-.103 1.312-.308.335-.205.502-.57.502-1.09 0-.578-.222-.96-.666-1.146-.383-.127-.872-.193-1.466-.193H4.89v2.738zm4.694 3.594c0-.645-.263-1.09-.79-1.33-.293-.135-.708-.204-1.24-.21H4.89v3.308h2.623c.54 0 .956-.07 1.257-.218.542-.27.814-.786.814-1.55zm12.308-2.02c.06.407.088.996.077 1.766h-6.472c.036.893.344 1.518.93 1.875.352.224.78.334 1.28.334.528 0 .958-.133 1.29-.408.18-.146.34-.352.477-.61h2.372c-.062.527-.348 1.062-.86 1.605-.796.864-1.91 1.298-3.344 1.298-1.183 0-2.226-.365-3.13-1.094-.903-.732-1.356-1.917-1.356-3.56 0-1.543.407-2.723 1.223-3.544.82-.823 1.876-1.233 3.18-1.233.772 0 1.47.138 2.09.416.62.277 1.13.714 1.534 1.315.364.53.598 1.14.708 1.838zm-2.335.233c-.043-.618-.25-1.085-.62-1.405-.37-.32-.83-.48-1.378-.48-.598 0-1.06.17-1.388.51-.33.336-.535.795-.62 1.375h4.005z', $paths->item( 9 )->getAttribute( 'd' ) );

		$this->assertEquals( $prefix . '-icon-github', $symbols->item( 10 )->getAttribute( 'id' ) );
		$this->assertEquals( 'M13.9 16.653c.4-.103.8-.103 1.199-.206 1.198-.31 2.197-.93 2.696-2.067.6-1.24.699-2.48.4-3.823-.1-.62-.4-1.033-.8-1.55-.1-.103-.1-.206-.1-.31.2-.826.2-1.549-.1-2.376 0-.103-.1-.206-.299-.206-.5 0-.899.206-1.298.413-.4.207-.7.413-.999.62-.1.103-.2.103-.3.103a9.039 9.039 0 0 0-4.693 0c-.1 0-.2 0-.3-.103-.698-.413-1.298-.827-2.096-.93-.5-.103-.5-.103-.6.413-.2.724-.2 1.447 0 2.17v.207c-.898 1.033-1.098 2.376-.898 3.616.1.413.1.723.2 1.136.499 1.447 1.497 2.273 2.995 2.687.4.103.8.206 1.298.31-.3.31-.499.826-.599 1.24 0 .103-.1.103-.1.103-.998.413-2.097.31-2.796-.827-.3-.516-.699-.93-1.398-1.033h-.5c-.199 0-.199.207-.099.31l.2.207c.499.31.898.826 1.098 1.446.4.93 1.099 1.343 2.097 1.447.4 0 .9 0 1.398-.104v1.963c0 .31-.3.517-.699.414a13.25 13.25 0 0 1-2.396-1.24c-2.996-2.17-4.594-5.166-4.394-8.989.2-4.753 3.595-8.575 8.089-9.505C15.298 1.156 20.29 4.462 21.69 9.73c1.298 5.166-1.598 10.538-6.392 12.192-.499.206-.799 0-.799-.62v-2.48c.1-.827 0-1.55-.599-2.17z', $paths->item( 10 )->getAttribute( 'd' ) );

		$this->assertEquals( $prefix . '-icon-codepen', $symbols->item( 11 )->getAttribute( 'id' ) );
		$this->assertEquals( 'M21.874 8.773L21.86 8.7l-.014-.04c-.007-.022-.013-.043-.022-.063-.006-.014-.012-.028-.02-.04-.01-.02-.018-.04-.028-.058l-.025-.04c-.01-.018-.022-.034-.035-.05l-.03-.038c-.012-.016-.027-.03-.04-.046l-.035-.033c-.015-.014-.032-.028-.048-.04-.012-.01-.025-.02-.04-.03-.004-.004-.008-.008-.013-.01l-9.085-6.057c-.287-.19-.66-.19-.947 0L2.392 8.21l-.014.01-.04.03-.047.04-.033.034-.043.047-.03.038-.035.05-.025.04-.03.057-.018.042-.022.062c-.005.013-.01.027-.013.04l-.015.072-.007.037c-.005.036-.008.073-.008.11v6.057c0 .037.003.075.008.11l.007.038.015.07.013.043.022.063c.006.015.012.03.02.043.008.02.017.038.028.057l.024.04c.01.017.022.034.035.05l.03.038.042.047.034.033c.017.014.033.028.05.04l.038.03.014.01 9.084 6.055c.143.096.308.144.473.144s.33-.048.473-.144l9.084-6.056.014-.01.04-.03c.017-.012.033-.025.048-.04.012-.01.023-.02.034-.032l.042-.047.03-.037.035-.05.024-.04.03-.057.018-.042.022-.062c.005-.014.01-.028.013-.042.006-.023.01-.047.015-.07l.007-.038c.004-.037.007-.074.007-.11V8.92c0-.037-.003-.074-.008-.11l-.006-.037zM11.95 13.97l-3.02-2.02 3.02-2.02 3.02 2.02-3.02 2.02zm-.854-5.524l-3.703 2.477-2.99-2 6.693-4.46v3.983zm-5.24 3.504L3.72 13.38v-2.86l2.137 1.43zm1.537 1.027l3.703 2.476v3.984l-6.692-4.46 2.99-2zm5.41 2.477l3.703-2.476 2.99 2-6.693 4.46v-3.984zm5.24-3.504l2.137-1.43v2.86l-2.137-1.43zm-1.536-1.028l-3.703-2.476V4.462l6.692 4.46-2.99 2z', $paths->item( 11 )->getAttribute( 'd' ) );
