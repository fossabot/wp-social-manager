...
class TestSettings extends WP_UnitTestCase {
	...
	public function test_settings_hooks() {
		...
		$this->assertEquals( 25, has_action( 'admin_init', array( $this->settings, 'setting_fields_buttons_mode' ) ) );
		$this->assertEquals( 25, has_action( 'admin_init', array( $this->settings, 'setting_fields_link_mode' ) ) );
