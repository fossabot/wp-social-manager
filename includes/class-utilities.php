...
class Utilities {
	 ...
	 * @return array|boolean   It returns an array of the supports variable, retyrn 'true'
	 * 						   if it is supported without the variable passed, and
...
class OptionUtilities extends Utilities {
	...
	public static function get_attr_prefix() {
		...
		$custom  = isset( $support['attr-prefix'] ) ? $support['attr-prefix'] : $default;
