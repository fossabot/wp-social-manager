...
class Widget_Social_Profile extends Widget {
	...
	public function __construct() {
		...
		$this->profiles = $this->plugin->option->get_list( 'social_profiles' );
		...
		<div class="<?php echo esc_attr( $this->id_base ); ?>">
			...
			<p>
				...
				<?php
					...
					$views = $this->plugin->option->get_list( 'button_views' ); ?>
			...
			<p>
				...
				<?php
					...
					$styles = $this->plugin->option->get_list( 'button_styles', array( 'widget_social_profile' ) ); ?>
